...
export async function GET() {
  ...
  try {
    ...
    if (responseBody.msg === 'success') {
      ...
      return NextResponse.json(responseSuccess(result), { headers: getCacheHeaders('netease') });
    }
    return NextResponse.json(responseSuccess(), { headers: getCacheHeaders('netease') });
  } catch {
